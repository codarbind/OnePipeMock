...
//data validation
let { account_number,  email, mobile_no, start_date, end_date} = req.body

if(!( account_number && email && mobile_no && start_date && end_date)) return res.send({message:'supply all compulsory inputs'})
